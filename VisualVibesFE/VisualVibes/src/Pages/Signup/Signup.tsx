...
import { formLabelEmail, formLabelPassword } from "../../Utils/const/labels";
...
const Signup: React.FC = () => {
  ...
  const fieldClassName = (
    ...
    const selectedClass = `signupInput ${
      fieldTouched && fieldError ? "errorInput" : ""
    }`;
  ...
  const formikStep2 = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      if (values.image) formData.append("ProfilePicture", values.image);
              ...
              <form onSubmit={formikStep1.handleSubmit} className="signupForm">
                ...
                <div className="formGroup">
                  <TextField
                    ...
                    className={fieldClassName(
                      formikStep1.touched.username,
                      formikStep1.errors.username
                    )}
                    {...formikStep1.getFieldProps("username")}
                    error={
                      formikStep1.touched.username &&
                      Boolean(formikStep1.errors.username)
                    }
                    helperText={
                      formikStep1.touched.username &&
                      formikStep1.errors.username
              ...
              <form onSubmit={formikStep2.handleSubmit} className="signupForm">
                ...
                <div className="formGroupRow">
                  <LocalizationProvider dateAdapter={AdapterDayjs}>
                    <DatePicker
                      ...
                      label="Date of birth"
                      onChange={(value) =>
                        formikStep2.setFieldValue("dateOfBirth", value)
                      }
                      slotProps={{
                        textField: {
                          variant: "outlined",
                          ...
                          error:
                            formikStep2.touched.dateOfBirth &&
                            Boolean(formikStep2.errors.dateOfBirth),
                          helperText:
                            formikStep2.touched.dateOfBirth &&
                            formikStep2.errors.dateOfBirth,
                        },
                      }}
                    />
                  ...
                  <FormControl
                    variant="outlined"
                    className={fieldClassName(
                      formikStep2.touched.role,
                      formikStep2.errors.role
                    )}
                    error={
                      formikStep2.touched.role &&
                      Boolean(formikStep2.errors.role)
                    }
                  >
                    ...
                    <Select
                      ...
                      onChange={(event) =>
                        formikStep2.setFieldValue("role", event.target.value)
                      }
                      label="Role"
                    >
                      <MenuItem value="">
                ...
                <div className="formGroup">
                  <TextField
                    ...
                    className={fieldClassName(
                      formikStep2.touched.bio,
                      formikStep2.errors.bio
                    )}
                    {...formikStep2.getFieldProps("bio")}
                    error={
                      formikStep2.touched.bio && Boolean(formikStep2.errors.bio)
                    }
                    helperText={
                      formikStep2.touched.bio && formikStep2.errors.bio
                    }
                  />
                </div>
                <div className="formGroup">
